...
function instNotifHtml(){
  ...
  return '<h2 style="margin:0 0 4px">Notificaties</h2>'+
    ...
    '<label style="display:flex;align-items:center;gap:8px;font-size:13px;margin:6px 0"><input type="radio" name="nt-modus" value="altijd"'+(t.modus!=="werkuren"?" checked":"")+' onchange="notifModus()"> Op elk moment van de dag</label>'+
    '<label style="display:flex;align-items:center;gap:8px;font-size:13px;margin:6px 0"><input type="radio" name="nt-modus" value="werkuren"'+(t.modus==="werkuren"?" checked":"")+' onchange="notifModus()"> Alleen tijdens mijn werkuren</label>'+
