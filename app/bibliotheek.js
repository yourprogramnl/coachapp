...
function ensureLibModals(){
  ...
  d.innerHTML='<div class="lmodal" id="exmodal"><div class="box">'+kop("exmodal-titel","Oefening bewerken")+
    ...
    '<div class="lmodal" id="invmodal"><div class="box"><h3 id="inv-titel">Klant toevoegen</h3>'+
      ...
      // Lidmaatschap staat niet meer in het venster: via Klanten nodig je altijd
      // een 1-op-1 klant uit, via Blog altijd een blog-lid (verzoek Stefan 25 juli).
      '<div class="sm muted" id="inv-uitleg" style="margin:-4px 0 12px"></div>'+
...
function progCard(w){
  ...
  if(isRest)return '<div class="mcard planned" onclick="event.stopPropagation();progOpenBuilder('+w.week+','+w.day+',\''+w.id+'\')"><div class="msc"><span style="color:#27b376">Rustdag</span></div></div>';
  let inner="";
