...
const HELP_HOOFDSTUKKEN=[
  ...
  },
  {
    ...
    stappen:[
      {titel:"De klantenlijst",
       ...
       tekst:"Bovenin staan vier cijfers over je hele klantenbestand: hoeveel actieve klanten je hebt, de gemiddelde compliance (met een keuzelijst voor de periode), de consult-rate over 30 dagen en hoeveel klanten je deze week gesproken hebt. Daaronder het zoekveld en de knoppen. In de tabel zie je per klant zijn eerstvolgende of gemiste workout, zijn compliance en zijn tags. Klik op een rij om de klant te openen."},
      ...
      {titel:"Werken met tags",
       ...
       tekst:"Tags zijn labels die je zelf maakt, bijvoorbeeld Wedstrijd, Blessure of Nieuw. Klik op de + achter een klant en vink een tag aan of uit. Onderin het venstertje maak je een nieuwe tag met een eigen kleur. Klik je op een tag in de lijst, dan filtert de lijst daarop en kun je die groep afvinken terwijl je programmeert. Met Tags beheren hernoem je tags of gooi je ze weg."},
  ...
  },
  {
    ...
    stappen:[
      ...
      {titel:"Een dag vullen",
       ...
       tekst:"Klik op een lege dag en je krijgt vier keuzes. Workout opent de bouwer zodat je zelf iets maakt. Rustdag zet de dag dicht. Programma opent je templates en weekworkouts om er een in te voegen. Plakken zet een workout die je eerder kopieerde op deze dag."},
  ...
  {
    id:"week",icoon:"i-fist",titel:"Weekworkout & leaderboard",
    intro:"De weekworkout is de enige workout die iedereen doet: je betalende klanten én de gratis blog-leden. Daar hoort een gedeeld leaderboard bij.",
    stappen:[
      {titel:"De weekworkouts",
       img:"img/help/week-01-lijst.png",
       tekst:"Elke weekworkout staat als kaart onder elkaar, de nieuwste bovenaan. Met + Nieuwe weekworkout maak je er een: naam, de workout-tekst met Rx en scaled, en het scoretype (tijd, rondes plus reps, reps, gewicht of vrije tekst). Hij staat direct live. Met de deel-link stuur je hem naar je leden."},
